			...
			function (e) {
				...
				const n = [],
					...
					o = function (e, s) {
						...
						a.observe(e, { attributes: void 0 === s.attributes || s.attributes, childList: void 0 === s.childList || s.childList, characterData: void 0 === s.characterData || s.characterData }),
							n.push(a);
					};
		...
		function (e) {
			...
			a("changeDirection", () => {
				...
				a("click", (e, s) => {
					...
					if (
						(Array.isArray(r) || (r = [r].filter((e) => !!e)), t.params.pagination.el && t.params.pagination.hideOnClick && r && r.length > 0 && !a.classList.contains(t.params.pagination.bulletClass))
					) {
